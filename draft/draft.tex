...
Note all the above is taking $f$ as given. Following \textcite{magnolfi2022}, let $f$ be a cubic polynomial in distance; that is:
...
\begin{figure}
    \begin{center}
        \includegraphics[width=\textwidth]{../elasticity_estimate/output/gamma_zoom_stacked.png}
...
These results affirm for me that the collaborative filtering results are likely to be quite predictive of a film's appeal. Thus, if my text-based model identifies the same pairs of films as substitutable, I can be more confident that the patterns I see reflect consumers' true preferences. 
